          ...
          sections={[
            {
              ...
              content: 'Bitcoin price (orange line) alongside key economic indicators. The yield curve (red/blue line) compares long-term and short-term U.S. Treasury rates. When it turns red (negative), it often signals an upcoming economic slowdown, and Bitcoin may rise as a hedge (e.g., the 2019 inversion before the 2020 crash). The white line tracks the Federal Funds Rate, showing U.S. interest rates. Rising rates can pressure Bitcoin prices down. The green line shows M2 money supply growth. When it is high, more money in the economy often boosts Bitcoin. Gray shaded areas mark U.S. recessions. Yellow bands highlight Bitcoin halvings (2012, 2016, 2020, 2024), events every ~4 years that cut the supply of new Bitcoin in half. Markers show key events like the 2014 Mt. Gox hack and the 2017 bull run peak.',
            },
            {
              title: 'How to interpret',
              content: 'Consider buying when the yield curve turns red or after a halving, as Bitcoin often rallies in these periods. Be cautious during recessions (gray areas) or when the Fed Funds Rate rises sharply, as Bitcoin may dip. Watch M2 growth: high values can signal bullish conditions. Historically, prices often rise 6 to 18 months after a halving due to reduced supply (e.g., post-2016 halving, Bitcoin surged in 2017). Use the time period selector to zoom in on specific periods, and hover over the chart for details like halving dates, events, or trading signals (e.g., "BTC may rally").',
            },
          ]}
        />
      )}
