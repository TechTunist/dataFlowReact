...
const FredSeriesChart = ({
    seriesId,
    isDashboard = false,
    chartType = 'area', // 'area', 'line', 'histogram', etc.
    valueFormatter = value => value.toLocaleString(), // Default formatter
    explanation = '',
    defaultScaleMode = 1, // 1 for logarithmic, 0 for linear
}) => {
    ...
    const [scaleMode, setScaleMode] = useState(defaultScaleMode);
    ...
    }, [seriesData, colors, scaleMode, chartType, valueFormatter, theme.palette.mode]);
