...
//         // Update layoutRef current with new x and y axis details
//         layoutRef.current = {
//             ...layoutRef.current,
//             xaxis: newLayout.xaxis || layoutRef.current.xaxis,
//             yaxis: newLayout.yaxis || layoutRef.current.yaxis,
//         };
...
//     useEffect(() => {
//     const filteredData = riskData.filter(item => {
//         const risk = item.Risk * 10; // Assuming Risk is from 0 to 1, scale it to 0-10
//         return selectedRiskRanges[Math.floor(risk / 2)]; // Adjust to how ranges are defined
//     });

//     setChartData(filteredData);
//     // Do not update the layout here
// }, [riskData, selectedRiskRanges]);
