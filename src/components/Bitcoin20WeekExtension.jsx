...
const extPadding = (extMax - extMin) * 0.1; // 10% padding for linear scale
setLayout(prevLayout => ({
...prevLayout,
xaxis: {
...prevLayout.xaxis,
...
<div
ref={containerRef}
className="chart-container" style={{ height: isDashboard ? '100%' : 'calc(100% - 40px)', width: '100%', border: '2px solid #a9a9a9' }}>
<Plot
