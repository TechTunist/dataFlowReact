...
const FearAndGreedChart = ({ isDashboard = false }) => {
    ...
    const [layout, setLayout] = useState({
        ...
        hovermode: 'closest', // Ensure tooltips show for the closest point
    });
    ...
    const datasets = useMemo(() => {
        ...
        // Single Bitcoin price line trace (visible, no Fear and Greed data in tooltip)
        const btcPriceLine = {
            ...
            name: 'Bitcoin Price',
            visible: true,
            hoverinfo: 'skip', // Skip tooltip for this trace to avoid overlap
        };
        ...
        // Create hidden traces for Bitcoin price tooltips (one per classification)
        const btcPriceTooltipDatasets = Object.keys(btcPriceTooltipGroups)
            ...
            .map(classification => ({
                ...
                type: 'scattergl',
                mode: 'none', // No visible lines or markers
                name: classification, // Name for internal reference, not shown in legend
