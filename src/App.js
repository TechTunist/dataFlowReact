                  ...
                  <main className="content" style={{ flex: 1 }}>
                    ...
                    <Routes>
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute>
                            <BasicChart ChartComponent={restrictToPaidSubscription(SahmRecessionIndicator)} />
                          </ProtectedRoute>
                        }
                      />
                      <Route
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute>
                            <BasicChart
                              ChartComponent={restrictToPaidSubscription(FredSeriesChart)}
                              seriesId="DFF"
                              chartType="line"
                              scaleMode="linear"
                      ...
                      <Route
                        ...
                        element={
                          <ProtectedRoute>
                            <BasicChart
                              ChartComponent={restrictToPaidSubscription(WorkbenchChart)}
                              seriesId="UMCSENT"
                              chartType="area"
                              valueFormatter={(value) => value.toLocaleString()}
                              showSP500Overlay={true}
