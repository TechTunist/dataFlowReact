...
const chartConfig = [
  ...
  { id: "fred-10-year-treasury", title: "10-Year Treasury Yield", linkTo: "/fred/10-year-treasury", component: (props) => <FredSeriesChart isDashboard={true} seriesId="DGS10" enableTechnicalIndicators={true} chartType="line" scaleMode="linear" valueFormatter={(value) => `${value.toFixed(2)}%`} {...props} />, description: "Daily 10-Year Treasury Note yield." },
  ...
  { id: "fred-crude-oil", title: "WTI Crude Oil Price", linkTo: "/fred/crude-oil", component: (props) => <FredSeriesChart isDashboard={true} seriesId="DCOILWTICO" enableTechnicalIndicators={true} chartType="area" scaleMode="linear" valueFormatter={(value) => `$${value.toFixed(2)}`} {...props} />, description: "Daily West Texas Intermediate crude oil price." },
  ...
  { id: "fred-nikkei-225", title: "Nikkei 225 Index", linkTo: "/fred/nikkei-225", component: (props) => <FredSeriesChart isDashboard={true} seriesId="NIKKEI225" chartType="area" scaleMode="linear" valueFormatter={(value) => value.toLocaleString()} {...props} />, description: "Stock market index for the 225 companies listed on the Tokyo stock exchange (TSE)." },
