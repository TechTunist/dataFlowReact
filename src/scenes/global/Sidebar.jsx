    ...
    <Box sx={{
      ...
      <Box textAlign="center" padding={theme.spacing(1)}> {/* Adjusted for consistent spacing */}
        ...
        <Typography variant="h5" color={colors.greenAccent[500]}>
          I'm a single developer trying to create a free useful tool for crypto people. If you found any value from this site, please consider donating some BTC. Thanks 
        </Typography>
      </Box>
    </Box>
      </ProSidebar>
