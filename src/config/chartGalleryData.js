export const placeholderImage = 'https://via.placeholder.com/300x200?text=Chart+Image';
...
export const chartSections = {
    ...
    "Stocks": [
      ...
      },
      {
        ...
        image: '/assets/stock-risk-color.png',
      },
    ],
    Price: [
      {
    ...
    "Advanced Models": [
      ...
      },
      {
        ...
        image: '/assets/tail-curvature.png',
      },
      {
        path: "/sahm-recession-indicator",
        title: "Sahm Rule",
        description: "Metric that signals a U.S. recession",
        image: '/assets/sahm-rule.png',
      },
    ],
    Tools: [
      {
      ...
      {
        path: "/dynamic-dca",
        title: "Dynamic DCA Simulator",
        description: "Backtest investment strategies based on past performance of specific indicators.",
        image: '/assets/dca-simulator.png',
      },
    ],
  };
